...
$MONO_PATH/../bin/mono $MONO_PATH/mono/4.5/xbuild.exe ../external/cecil/Mono.Cecil.csproj             $common_args
$MONO_PATH/../bin/mono $MONO_PATH/mono/4.5/xbuild.exe ../external/cecil/rocks/Mono.Cecil.Rocks.csproj $common_args
