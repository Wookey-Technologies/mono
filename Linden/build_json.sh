...
for CONFIG in Debug Release; do
    ...
    $MONO_PATH/../bin/mono $MONO_PATH/mono/4.5/xbuild.exe /nologo /verbosity:n ../external/Newtonsoft.Json/Src/Newtonsoft.Json/Newtonsoft.Json.csproj $common_args /t:Build
