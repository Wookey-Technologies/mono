...
for CONFIG in Release Debug; do
    ...
    $MONO_EXE $MONO_PATH/mono/4.5/xbuild.exe /nologo /verbosity:n ../external/Newtonsoft.Json/Src/Newtonsoft.Json/Newtonsoft.Json.csproj $common_args /t:Build


    $MONO_EXE $MONO_LIBDIR/sn.exe -q -R $MONO_LIBDIR/Newtonsoft.Json.dll ../external/Newtonsoft.Json/Src/Newtonsoft.Json/Dynamic.snk
    $MONO_EXE $MONO_PATH/mono/4.5/gacutil.exe -i $MONO_PATH/mono/4.5/Newtonsoft.Json.dll
done
